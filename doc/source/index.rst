...
VAMDC e-science infrastructure uses a data model that is serialized in a XML schema called VAMDC-XSAMS schema. The links points to the latest release of the VAMDC-XSAMS schema (though the previous releases are left below for history)
...
* The automatically generated documentation of the schema is can be `viewed <http://www.vamdc.eu/documents/vamdc-xsams-doc-1.0>`_ or `downloaded <http://www.vamdc.org/downloads/vamdc-xsams-doc-v1.0.tar.bz2>`_
