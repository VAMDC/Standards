...
\textbf{Editors: } & VAMDC \\
\textbf{Authors:} & VAMDC \\ %\hline 
\textbf{Contributors:} & VAMDC \\ %\hline 
...
\textbf{Abstract:} & 
This document describes standards used by VAMDC.
\end{tabular}
...
V11.5 & 27/05/2011 &   & first release \\ \hline 
 &  &  &  \\ \hline 
 &  &  &  \\ \hline 
 &  &  &  \\ \hline 
\end{tabular}
