...
\textbf{Date:} & 08/12/2011 \\ %\hline
\textbf{Document code:} &  \\ %\hline 
\textbf{Document URL:} & \url{http://www.vamdc.org/documents/vamdc-xsams-guide_v11.12.pdf} \\ %\hline 
...
The internal version of the schema described is 0.3.
