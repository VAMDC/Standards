...
latex_documents = [
  ('index', 'XSAMSDocs.tex', u'XSAMS-VAMDC Changelog Documentation',
...
man_pages = [
    ('index', 'xsamsdocs', u'XSAMS-VAMDC Changelog Documentation',
